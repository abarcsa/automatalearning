...
public class ValidTraceModel implements PartialModel {
	...
	public ValidTraceModel(List<String> inputAlphabet, List<String> outputAlphabet, List<String> inputSequence, List<String> outputSequence) {
