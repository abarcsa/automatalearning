 ...
 */
package hu.bme.mit.mealymodel.xtext.services;
...
@Singleton
public class MealymachineDslGrammarAccess extends AbstractGrammarElementFinder {
	
	public class MealyMachineElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "hu.bme.mit.mealymodel.xtext.MealymachineDsl.MealyMachine");
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "hu.bme.mit.mealymodel.xtext.MealymachineDsl.State");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AlphabetElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "hu.bme.mit.mealymodel.xtext.MealymachineDsl.Alphabet");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TransitionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "hu.bme.mit.mealymodel.xtext.MealymachineDsl.Transition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EStringElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "hu.bme.mit.mealymodel.xtext.MealymachineDsl.EString");
	...
	@Inject
	public MealymachineDslGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("hu.bme.mit.mealymodel.xtext.MealymachineDsl".equals(grammar.getName())) {
				return grammar;
			}
