 ...
 * @generated
 */
public class MealymodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MealymodelPackage.MEALY_MACHINE: {
				...
				T result = caseMealyMachine(mealyMachine);
	 ...
	 * @generated
	 */
	public T caseMealyMachine(MealyMachine object) {
		return null;
	}
